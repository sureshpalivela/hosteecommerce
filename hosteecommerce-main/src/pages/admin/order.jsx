...
const OrderDetailsModal = ({ order, onClose, onTrackShipping }) => {
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold">{order.trackingId || 'Not Assigned'}</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-xl font-bold text-pink-600">Rs.{order.price}</p>
          </div>

          <button 
            onClick={() => onTrackShipping(order.trackingId)} 
...
const Orders = () => {
  ...
  const handleTrackShipping = (trackingId) => {
    if (!trackingId) {
      alert('Tracking ID not available for this order.');
      return;
    }

    const shippingUrl = `https://trackingwebsite.com/track/${trackingId}`;
